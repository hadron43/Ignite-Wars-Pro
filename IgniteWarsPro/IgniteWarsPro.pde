...
Serial player1 = new Serial(this, Serial.list() [0], 9600);
Serial player2 = new Serial(this, Serial.list() [1], 9600);
...
class vector extends coord
{
  ...
  void Rotate(boolean clockwise, float unit)
  {
    ...
    modulus=(float)Math.pow(tempX*tempX+tempY*tempY, 0.5);
    tempX/=modulus;
    tempY/=modulus;
...
{  
  ...
  else
  {
    ...
    {
      input1=player1.readStringUntil(10);
      ...
      if(input1 != null)
      {
        ...
        print(input1);
        if(input1.contains("IP"))
          sS=aA=false;
          //print("holaaaaa");
        else if(input1.contains("CW"))
          sS=true;
        else if(input1.contains("AC"))
          aA=true;
        else if(input1.contains("SS"))
          wW=!wW;
        else if(input1.contains("FF"))
          eE=true;
      }
    }
    ...
    {
      input2=player2.readStringUntil(10);
      ...
      if(input2 != null)
      {
        ...
        print(input2);
        if(input2.contains("IP"))
          jJ=kK=false;
          //print("holaaaaa");
        else if(input2.contains("CW"))
          kK=true;
        else if(input2.contains("AC"))
          jJ=true;
        else if(input2.contains("SS"))
          iI=!iI;
        else if(input2.contains("FF"))
          oO=true;
      }
    }
    
    //End of taking input fromm serial monitor
